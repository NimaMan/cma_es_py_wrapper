...
class CMAES : public libcmaes::ESOStrategy<libcmaes::CMAParameters<libcmaes::GenoPheno<libcmaes::NoBoundStrategy>>, libcmaes::CMASolutions>
    {
    public:
        /**
        * \brief dummy constructor
        */
        CMAES(): libcmaes::ESOStrategy<libcmaes::CMAParameters<libcmaes::GenoPheno<libcmaes::NoBoundStrategy>>, libcmaes::CMASolutions >(){};
        /**
         * \brief constructor.
         * @param parameters stochastic search parameters
         */
        CMAES(libcmaes::CMAParameters<libcmaes::GenoPheno<libcmaes::NoBoundStrategy>> &parameters): libcmaes::ESOStrategy<libcmaes::CMAParameters<libcmaes::GenoPheno<libcmaes::NoBoundStrategy>>, libcmaes::CMASolutions >(parameters){
        ...
        */
        ...
        CMAES(libcmaes::CMAParameters<libcmaes::GenoPheno<libcmaes::NoBoundStrategy>> &parameters, const libcmaes::CMASolutions &cmasols)
        :libcmaes::ESOStrategy<libcmaes::CMAParameters<libcmaes::GenoPheno<libcmaes::NoBoundStrategy>>, libcmaes::CMASolutions >(parameters,cmasols){
      ...
      */
      ...
      libcmaes::CovarianceUpdate::update(this->_parameters,_esolver,this->_solutions);
