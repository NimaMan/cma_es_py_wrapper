...
namespace libcmaes
{
  ...
  template <class TESOStrategy,class TParameters>
    ...
    public:
         ...
         */
        ESOptimizer():TESOStrategy(){}
      
      /**
       * \brief constructor
       * @param parameters optimization parameters
       */
      ESOptimizer(TParameters &parameters):TESOStrategy(parameters){}
       ...
       */
      ESOptimizer(TParameters &parameters, const CMASolutions &solution):TESOStrategy(parameters,solution){}
