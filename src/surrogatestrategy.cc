...
namespace libcmaes
{
  ...
  SurrogateStrategy<TStrategy,TCovarianceUpdate,TGenoPheno>::SurrogateStrategy(CMAParameters<TGenoPheno> &parameters)
    :TStrategy<TCovarianceUpdate,TGenoPheno>(parameters)
  {
